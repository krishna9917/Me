...
class GetProfiledata {
  ...
  factory GetProfiledata.fromJson(Map<String, dynamic> json) => GetProfiledata(
        ...
        mcxIntraday:
            List<Mcx>.from(json["mcx_intraday"].map((x) => Mcx.fromJson(x))),
        mcxHolding:
            List<Mcx>.from(json["mcx_holding"].map((x) => Mcx.fromJson(x))),
        mcxBrokeragePerLot:
            McxBrokeragePerLot.fromJson(json["mcx_brokerage_per_lot"]),
      );
...
class McxBrokeragePerLot {
  ...
  factory McxBrokeragePerLot.fromJson(Map<String, dynamic> json) =>
      McxBrokeragePerLot(
        gold: json["GOLD"],
