...
List<LiveRateToken> liveRateTokenFromJson(String str) => List<LiveRateToken>.from(json.decode(str).map((x) => LiveRateToken.fromJson(x)));

String liveRateTokenToJson(List<LiveRateToken> data) => json.encode(List<dynamic>.from(data.map((x) => x.toJson())));
