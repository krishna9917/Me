...
String portfolioCloseListToJson(PortfolioCloseList data) => json.encode(data.toJson());
...
class PortfolioCloseList {
  ...
  factory PortfolioCloseList.fromJson(Map<String, dynamic> json) => PortfolioCloseList(
    status: json["status"],
