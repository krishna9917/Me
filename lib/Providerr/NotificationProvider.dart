...
final notificationServiceProvider = Provider<NotificationService>((ref) {
  return NotificationService('https://www.onlinetradelearn.com/mcx/authController/getNotificationList');
});

final notificationProvider = StateNotifierProvider<NotificationNotifier, GetNotification?>((ref) {
  ...
  Future<GetNotification> getNotifications(String userId) async {
    final response = await http.post(
      ...
      headers: {
        ...
        'Token': 'bXdSSmNIOHFOS2RoQTNES0hJYndwNmxjS1ZzbkVzZzVNSWdOVHZqRmh0MUFLNTJhSXZFYUdiQzVWS2Z3Z0V5TTNTejI1WWFoRm5MTWFJcTNlczJPajRlMk9qQ2dtZ3dYcExWVU1Laml4SlE9',
        'Deviceid': '12345678',
      },
      body: {
        'userID': userId,
